...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='payment',
            name='details',
            field=django.contrib.postgres.fields.jsonb.JSONField(blank=True, null=True, verbose_name='details'),
        ),
        migrations.AlterField(
            model_name='payment',
            name='error_code',
        ...
        migrations.AlterField(
            model_name='payment',
            name='status',
            field=models.PositiveSmallIntegerField(choices=[(0, 'Created'), (1, 'Pending'), (2, 'Succeeded'), (3, 'Failed'), (4, 'Refunded')], db_index=True, default=sberbank.models.Status['CREATED'], verbose_name='status'),
        ),
        migrations.AlterField(
            model_name='payment',
            name='updated',
